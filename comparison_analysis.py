...
plt.plot(years, avg_scores, marker="o", linewidth=2, markersize=10, color="blue")
...
if avg_scores[-1] > avg_scores[0]:
    print(f"Global happines increased from {avg_scores[0]:.3f} to {avg_scores[-1]:.3f}")
else:
    print(
